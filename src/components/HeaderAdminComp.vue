    ...
    <nav class="navbar">
      <div class="container-fluid flex-nowrap">
        ...
        <div class="nav-interact">
          <router-link v-if="!$store.state.isLogin" to="/login" class="btn btn-primary me-3">Login</router-link>
          <router-link v-if="!$store.state.isLogin" to="/register" class="btn btn-primary">Register</router-link>
